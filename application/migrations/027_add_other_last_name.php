 ...
 */
class Migration_Add_other_last_name extends CI_Migration
{
    /**
     * Upgrade method.
     */
    public function up()
    {
        ...
        if (!$this->db->field_exists('other_last_name', 'users'))
            $fields['other_last_name'] = ['type' => 'VARCHAR', 'constraint' => '256', 'null' => TRUE];
    ...
    {
        $this->dbforge->drop_column('users', 'other_last_name');
    }
}
